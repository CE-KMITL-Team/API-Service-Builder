	...
	const handleSaveModel = async () => {
		const cleanedModelFields = modelFields.map((field) => {
			...
			const filteredField = Object.fromEntries(
				Object.entries(cleanedField).filter(
					([_, value]) => value !== null
				)
			);
					...
					<div className="check-list ml-3 flex flex-col">
						<div className="group flex gap-x-3">
							<input
								...
								id="insert_all"
								onChange={() =>
									handleCheckboxChange("insert all")
								}
							/>
							<label
								htmlFor="insert_all"
					...
					<div className="check-list ml-3 flex flex-col">
						<div className="group flex gap-x-3">
							<input
								...
								id="delete_one"
								onChange={() =>
									handleCheckboxChange("delete one")
								}
							/>
							<label
								htmlFor="delete_one"
						...
						<div className="group flex gap-x-3">
							<input
								...
								id="delete_all"
								onChange={() =>
									handleCheckboxChange("delete all")
								}
							/>
							<label
								htmlFor="delete_all"
