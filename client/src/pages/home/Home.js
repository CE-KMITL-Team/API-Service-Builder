    ...
    <div className="home text-center mt-14 mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 pb-96 mb-24">
      <div className="title px-10">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900">
          What is
          <span className="text-primary-700">&nbsp;API Service Builder</span>
        </h1>
        <h2 className="text-2xl tracking-tight text-gray-600 mt-3">
          streamlines API development, saving time and resources. It eliminates
          the need for
          <br /> extensive back-end coding knowledge and offers databases, APIs,
          and service hosts.
        </h2>
          ...
          <article className="flex max-w-xl flex-col items-start justify-between w-2/5">
            <div className="group relative p-5 shadow-lg bg-white rounded-lg">
              <p className="text-md leading-6 text-gray-600">
                Creating APIs is complex, but "API Service Builder" simplifies
                it with code-free database creation, API design, and hosting
                services, removing server setup concerns.
              </p>
            </div>
          </article>
